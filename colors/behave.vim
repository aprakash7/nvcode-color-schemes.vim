...
hi BufferCurrent guifg=#d2d8e1 ctermfg=253 guibg=#ffffff ctermbg=231 gui=NONE cterm=NONE
hi BufferCurrentIndex guifg=#569cd6 ctermfg=74 guibg=#ffffff ctermbg=231 gui=NONE cterm=NONE
hi BufferCurrentMod guifg=#d2d8e1 ctermfg=253 guibg=#ffffff ctermbg=231 gui=NONE cterm=NONE
hi BufferCurrentSign guifg=#569cd6 ctermfg=74 guibg=#ffffff ctermbg=231 gui=NONE cterm=NONE
hi BufferCurrentTarget guifg=#d16969 ctermfg=167 guibg=#ffffff ctermbg=231 gui=bold cterm=bold
hi BufferVisible guifg=#d2d8e1 ctermfg=253 guibg=#ffffff ctermbg=231 gui=NONE cterm=NONE
hi BufferVisibleIndex guifg=#d2d8e1 ctermfg=253 guibg=#ffffff ctermbg=231 gui=NONE cterm=NONE
hi BufferVisibleMod guifg=#d2d8e1 ctermfg=253 guibg=#ffffff ctermbg=231 gui=NONE cterm=NONE
hi BufferVisibleSign guifg=#d2d8e1 ctermfg=253 guibg=#ffffff ctermbg=231 gui=NONE cterm=NONE
hi BufferVisibleTarget guifg=#d16969 ctermfg=167 guibg=#ffffff ctermbg=231 gui=bold cterm=bold
